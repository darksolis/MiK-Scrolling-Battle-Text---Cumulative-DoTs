...
obj["NOTIFICATION_SOUL_SHARD_CREATED"]	= { label="Получ. камня душ", tooltip="Вкл/Выкл оповещение когда вы получаете  камень душ."}
obj["NOTIFICATION_EXTRA_ATTACK"]		= { label="Экстра атаки", tooltip="Вкл/Выкл оповещение когда вы получаете дополнительные атаки такие как Ярость ветра, thrash, sword spec, и т.д."}
...
obj["recipientControl"]			= "Получатель контроля юнита"
